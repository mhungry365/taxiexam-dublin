...
export const metadata: Metadata = {
  title: "Terms",
  description: "Terms for TaxiPass Dublin."
};
      ...
      <div className="container max-w-3xl">
        <Card className="p-8">
          ...
          <div className="mt-6 space-y-4 leading-7 text-muted-foreground">
            <p>TaxiPass Dublin provides revision tools, progress tracking, and original sample practice content for SPSV test preparation.</p>
