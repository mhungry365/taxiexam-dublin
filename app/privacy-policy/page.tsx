...
export const metadata: Metadata = {
  ...
  description: "Privacy policy for TaxiExam Dublin."
};
      ...
      <div className="container max-w-3xl">
        <Card className="p-8">
          ...
          <div className="mt-6 space-y-4 leading-7 text-muted-foreground">
            <p>TaxiExam Dublin stores account, quiz, study-plan, and progress data so learners can track preparation for the Dublin SPSV / Taxi Driver Entry Test.</p>
